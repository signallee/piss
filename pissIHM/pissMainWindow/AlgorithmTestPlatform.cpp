                                             ...
                                             int appHeight)
{
    ...
    this->setFixedHeight(this->appHeight*0.1);
    this->initVariable();
    this->constructIHM();
    this->setConnections();
...
void AlgorithmTestPlatform::constructIHM(){
    ...
    this->algorithmTestTitleLabel->setFixedHeight(this->appHeight*0.03/1.8);
    ...
    this->algorithmTestCommandLabel->setFixedHeight(this->appHeight*0.03/1.8);
    ...
    this->cpuLabel->setFixedSize(appWidth*0.02,appHeight*0.02/1.8);
    ...
    this->ramLabel->setFixedSize(appWidth*0.02,appHeight*0.02/1.8);
    ...
    this->diskLable->setFixedSize(appWidth*0.02,appHeight*0.02/1.8);
    ...
    this->netLable->setFixedSize(appWidth*0.02,appHeight*0.02/1.8);
    ...
    this->cpuProgressBar->setFixedHeight(appHeight*0.016/1.8);
    ...
    this->ramProgressBar->setFixedHeight(appHeight*0.016/1.8);
    ...
    this->diskProgressBar->setFixedHeight(appHeight*0.016/1.8);
    ...
    this->netProgressBar->setFixedHeight(appHeight*0.016/1.8);
    ...
    this->algorithmTestStatusLabel->setFixedHeight(this->appHeight*0.08/1.8);
    ...
    systemCommand->setFixedHeight(this->appHeight*0.03/1.8);
